...
def _autocovariance(
    ...
    """
    Computes the autocovariance function of fractional Gaussian noise (fGn).
...
def generate_cholesky(
    ...
    """
    Generates fractional Gaussian noise (fGn) using the Cholesky Decomposition method.
    
    Exact method (Asmussen & Glynn, 2007).
    Uses Sigma = L * L^T.
    """
